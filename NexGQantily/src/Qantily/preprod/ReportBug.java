...
public class ReportBug {
	WebDriver driver;
	  ...
	  public void login_before_project() throws Exception {
		  ...
		  //enter email address
		  Thread.sleep(2000);
		  driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div[2]/div[3]/form/div[1]/input")).sendKeys("shreysrivastav3@gmail.com");
		  
		  //enter password
		  Thread.sleep(2000);
		  driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/div[2]/div[3]/form/div[2]/input")).sendKeys("qwerty7890");
